              ...
              <div className="flex items-center gap-2 shrink-0">
                {isAnyFilterActive && (
                  <button
                    ...
                    className="text-xs font-semibold text-amber-400 hover:text-amber-300 bg-amber-500/10 border border-amber-500/20 px-3 py-2.5 rounded-xl transition-all cursor-pointer active:scale-95"
                  >
                    Restablecer
                  </button>
                )}
                <button
                  ...
                  className={`px-3 py-2.5 rounded-xl text-xs font-bold flex items-center gap-1.5 border cursor-pointer active:scale-95 ${
                ...
                >
                  ...
                  {advancedFilterCount > 0 && (
                    <span className="min-w-5 h-5 px-1 rounded-full bg-black/20 flex items-center justify-center font-mono font-bold">
                      {advancedFilterCount}
                    </span>
                  )}
                </button>
